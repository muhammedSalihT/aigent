      ...
      child: Column(
        children: [
          const SectionHeader(
            ...
            subtitle: 'Six reasons top businesses choose AIgent softwares as their technology partner.',
          ),
...
class _FeatureTile extends StatelessWidget {
  ...
  const _FeatureTile({required this.icon, required this.title, required this.desc, required this.index});
      ...
      child: AnimatedContainer(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(desc, style: AppTypography.caption, maxLines: 3, overflow: TextOverflow.ellipsis),
          ],
        ),
      )
