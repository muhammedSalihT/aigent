class AppConstants {
  ...
  static const String taglineShort = 'We automate workflows, reduce manual effort, and ship AI-powered apps that scale.';
  ...
  static const List<Map<String, dynamic>> services = [
    {
      ...
      'features': ['iOS & Android', 'Flutter Cross-Platform', 'UI/UX Design', 'App Store Launch'],
      'icon': 'mobile',
    },
    {
      ...
      'features': ['3D Experiences', 'PWA & SPA', 'Performance Optimized', 'SEO-First'],
      'icon': 'web',
    },
    {
      ...
      'features': ['CRM Automation', 'AI Sales Bots', 'Data Pipelines', 'Custom LLM Agents'],
      'icon': 'ai',
    },
  ];
  ...
  static const List<Map<String, String>> whyChooseUs = [
    {
      ...
      'desc': 'Every solution is built with artificial intelligence at its core, not as an afterthought.',
    },
    {
      'icon': '🏗️',
      'title': 'Scalable Architecture',
      'desc': 'Clean, modular codebases that grow with your business from day one to million users.',
    },
    {
      'icon': '⚡',
      'title': 'Fast Delivery',
      'desc': 'Rapid development cycles with continuous delivery. From concept to launch in weeks.',
    },
    {
      'icon': '🤖',
      'title': 'Custom AI Agents',
      'desc': 'Bespoke intelligent agents trained on your data and integrated into your workflow.',
    },
    {
      'icon': '📱',
      'title': 'Cross-Platform',
      'desc': 'One codebase, every platform. Web, iOS, Android — pixel-perfect on all screens.',
    },
    {
      'icon': '🔧',
      'title': 'End-to-End Support',
      'desc': 'From discovery to deployment and beyond — we\'re your long-term technology partner.',
    },
  ];
  ...
  static const List<Map<String, dynamic>> portfolio = [
    ...
    },
    {
      ...
      'description': 'Cross-platform health monitoring app with AI-powered insights, real-time vitals tracking, and personalized recommendations.',
    ...
    },
    {
      ...
      'description': 'High-conversion e-commerce web app with 3D product previews, AI recommendations, and seamless checkout flow.',
      'tags': ['Web', 'Flutter', '3D'],
    ...
    },
    {
      ...
      'description': 'AI agent that monitors stock levels, predicts demand, auto-raises purchase orders, and generates supplier reports.',
  ...
  static const List<Map<String, String>> processSteps = [
    {
      'step': '01',
      'title': 'Discovery',
      'desc': 'We deep-dive into your business goals, pain points, and vision to define the perfect solution.',
    },
    {
      'step': '02',
      'title': 'Design',
      'desc': 'Wire-frames, UI mockups, and interactive prototypes — all aligned with your brand.',
    },
    {
      'step': '03',
      'title': 'Build',
      'desc': 'Agile sprints, clean code, continuous integration — shipping features fast and reliably.',
    },
    {
      'step': '04',
      'title': 'Test',
      'desc': 'Rigorous QA, performance testing, and AI validation before anything touches production.',
    },
    {
      'step': '05',
      'title': 'Launch',
      'desc': 'Deployment, monitoring setup, and 30-day post-launch support included.',
    },
  ];
  ...
  static const List<Map<String, String>> team = [
    {
      ...
      'bio': 'AI engineer with 8+ years building intelligent systems for enterprises across MENA and Europe.',
      'avatar': 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&q=80',
    },
    {
      'name': 'Sara Khalid',
      'role': 'Head of Flutter Development',
      'bio': 'Flutter expert and Google Developer Expert with 50+ shipped cross-platform apps.',
      'avatar': 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=300&q=80',
    },
    {
      'name': 'Omar Yusuf',
      'role': 'Full-Stack Web Architect',
      'bio': 'Specializes in 3D web experiences, performance optimization, and scalable backend systems.',
