...
class AppTypography {
  ...
  static TextStyle get displayLarge =>
      poppins(fontSize: 72, fontWeight: FontWeight.w800, height: 1.1);
  static TextStyle get displayMedium =>
      poppins(fontSize: 56, fontWeight: FontWeight.w700, height: 1.15);
  static TextStyle get displaySmall =>
      poppins(fontSize: 40, fontWeight: FontWeight.w700, height: 1.2);
  ...
  static TextStyle get bodyLarge => poppins(
      fontSize: 18, fontWeight: FontWeight.w400, color: AppColors.textMuted);
